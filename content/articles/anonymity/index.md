...
В статье [по настройке своего VPN](/articles/vpn_server/) (выйдет в ближайшие дни) мы разберём, как запустить собственный сервер с протоколом VLESS.
...
На форумах есть множество гайдов по поднятию своего VPN-сервера, но я сделал и [свой](/articles/vpn_server/) (выйдет в ближайшие дни), в котором рассказано об установке VPN с помощью панели 3X-UI и протокола VLESS. Всё описано пошагово, доступно, прописаны все команды, в общем справиться должен каждый.
